...
import { Loader2, AlertCircle, Eye, EyeOff, Store, Shield } from "lucide-react";

export default function AdminLoginPage() {
  const [form, setForm] = useState({ storeSlug: "onlinebdshop", email: "", password: "" });
  ...
  const handleSubmit = useCallback(
    async (e) => {
      ...
      if (!form.storeSlug.trim())
        setForm((f) => ({ ...f, storeSlug: "onlinebdshop" }));
  ...
  const fillDemo = useCallback(() => {
    setForm({ storeSlug: "onlinebdshop", email: "admin@acme.com", password: "Secure123!" });
  }, []);
        ...
        <div style={{ width: "100%", maxWidth: "380px" }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: "16px" }}>
              ...
              >
                Defaults to the primary single-store setup. Leave as onlinebdshop unless you have renamed your store.
              </p>
            </div>
            ...
            <button
              ...
              style={{
                ...
                background: isLoading
                  ? "#475569"
                  : "linear-gradient(135deg, var(--accent, #2563eb) 0%, var(--accent-warm, #f97316) 100%)",
                color: "white",
                fontSize: "14px",
                fontWeight: "700",
