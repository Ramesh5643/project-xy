      ...
      >
        ...
        <a
          ...
          style={{
            ...
            padding: "9px 18px",
            borderRadius: "9px",
            background: "linear-gradient(135deg, var(--accent, #2563eb), var(--accent-warm, #f97316))",
            color: "#ffffff",
            fontSize: "13px",
            fontWeight: "700",
            textDecoration: "none",
              ...
              p === "..." ? (
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "7px",
                    padding: "0 4px",
                    border: `1.5px solid ${pageIndex === p ? "var(--accent, #2563eb)" : "#e2e8f0"}`,
                    background: pageIndex === p ? "var(--accent, #2563eb)" : "none",
