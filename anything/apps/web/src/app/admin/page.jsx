...
function KPICard({
  ...
  const card = (
    <div
      style={{
        padding: "20px",
        background: "var(--color-surface, rgba(255,255,255,0.82))",
      ...
      onMouseEnter={(e) => {
        if (href) {
          e.currentTarget.style.boxShadow = "0 16px 40px rgba(15,23,42,0.09)";
      ...
      >
        ...
        <a
          ...
          style={{
            ...
            padding: "9px 16px",
            borderRadius: "999px",
            background: "linear-gradient(135deg, var(--color-accent-primary, #2C3E6B), var(--color-accent-cta, #E8542A))",
            color: "#ffffff",
            fontSize: "13px",
            fontWeight: "600",
            textDecoration: "none",
