...
export function applyTheme(tc = {}) {
  ...
  const accentCta =
    tc["--sf-accent-cta"] || tc["--accent-cta"] || tc.accentCta || DEFAULTS.accentCta;
...
export default function StorefrontLayout({ children }) {
  const storeSlug =
    typeof window !== "undefined"
      ? window.location.pathname.split("/").filter(Boolean)[0] || "onlinebdshop"
      : "onlinebdshop";
