          ...
          {images.map((im, i) => (
            <button
              ...
              style={{
                ...
                borderRadius: "10px",
                overflow: "hidden",
                border: `2.5px solid ${i === idx ? "var(--color-accent-primary, var(--accent, #2C3E6B))" : "var(--color-border, #e5e7eb)"}`,
          ...
          return (
            <button
              ...
              style={{
                padding: "7px 16px",
                borderRadius: "9px",
                border: `2px solid ${active ? "var(--color-accent-primary, var(--accent, #2C3E6B))" : "var(--color-border, #e5e7eb)"}`,
                background: active ? "var(--accent-muted, rgba(44, 62, 107, 0.12))" : "var(--color-surface, #fff)",
                color: active ? "var(--color-accent-primary, var(--accent, #2C3E6B))" : "var(--color-text-secondary, #374151)",
                fontSize: "13px",
                fontWeight: "600",
                cursor: "pointer",
            ...
            <>
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: "12px",
                  border: "none",
                  background: "var(--color-accent-cta, var(--accent, #E8542A))",
                  color: "#fff",
                  fontSize: "16px",
                  fontWeight: "800",
                  cursor: "pointer",
              ...
              <button
                ...
                style={{
                  ...
                  padding: "14px",
                  borderRadius: "12px",
                  border: "2px solid var(--color-accent-primary, var(--accent, #2C3E6B))",
                  background:
                    cartState === "added"
                      ? "var(--accent-muted, rgba(44, 62, 107, 0.12))"
                      : "var(--color-surface, #fff)",
                  color: "var(--color-accent-primary, var(--accent, #2C3E6B))",
                  fontSize: "14px",
                  fontWeight: "700",
                  cursor: "pointer",
                  display: "flex",
