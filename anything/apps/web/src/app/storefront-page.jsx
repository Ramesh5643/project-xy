  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: "var(--color-surface, var(--sf-surface, #fff))",
          border: "1px solid var(--color-border, var(--sf-border, rgba(26,26,46,0.08)))",
          borderRadius: "18px",
          padding: "10px",
          boxShadow: "0 16px 36px rgba(26,26,46,0.06)",
      ...
      >
        ...
        >
          ...
          {discount > 0 && (
            <span
              style={{
                ...
                top: "10px",
                left: "10px",
                background: "var(--color-accent-primary, var(--sf-accent, #2C3E6B))",
                color: "#fff",
                fontSize: "10px",
                fontWeight: "800",
                padding: "3px 8px",
          ...
          <button
            ...
            style={{
              ...
              right: 0,
              padding: "14px",
              background: added ? "rgba(22,163,74,0.9)" : "var(--color-accent-cta, var(--accent-warm, #E8542A))",
        ...
        <div style={{ paddingTop: "12px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "6px", marginBottom: "8px" }}>
            <span style={{ fontSize: "12px", color: "#f59e0b", fontWeight: "700" }}>★ 4.7</span>
            <span style={{ fontSize: "11px", color: "var(--sf-text2, #64748b)" }}>Trusted pick</span>
          </div>
...
function BentoHero({ config, storeSlug }) {
  ...
  return (
    <div
      style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 20px 34px" }}
    >
      <div
        style={{
          display: "grid",
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: "28px",
            overflow: "hidden",
            background: "linear-gradient(135deg, var(--color-accent-primary, #2C3E6B) 0%, var(--color-accent-cta, #E8542A) 100%)",
            position: "relative",
            minHeight: "420px",
            display: "flex",
            flexDirection: "column",
            ...
            <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
              <a
                ...
                style={{
                  ...
                  padding: "13px 24px",
                  borderRadius: "999px",
                  background: "var(--color-accent-cta, var(--accent-warm, #E8542A))",
                  color: "#fff",
                  fontSize: "14px",
                  fontWeight: "800",
                  textDecoration: "none",
    ...
    <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 20px" }}>
      <div
        style={{
          ...
          borderRadius: "24px",
          overflow: "hidden",
          border: "1px solid var(--sf-border, rgba(15,23,42,0.08))",
